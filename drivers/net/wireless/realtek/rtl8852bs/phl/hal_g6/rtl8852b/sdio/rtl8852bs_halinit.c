				 ...
				 struct hal_init_info_t *init_52bs)
{
	...
	#ifdef RTW_WKARD_PHL_SD_RESET_DISABLE
	intf_info->sdio_intf_info.sd_reset = MAC_AX_SDIO_DISABLE;
	#else
	intf_info->sdio_intf_info.sd_reset = MAC_AX_SDIO_IGNORE;
	#endif

	#ifndef CONFIG_RTL8852BT
